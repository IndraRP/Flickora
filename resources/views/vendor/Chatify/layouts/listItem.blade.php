...
@if ($get == "users" && !!$lastMessage)
    ...
    <a href="/chatify/{{ $user->id }}" class="text-decoration-none">
            ...
            <tr data-id="{{ $user->id }}">
                ...
                <td style="position: relative">
                    ...
                    <div class="avatar av-m" style="background-image: url('{{ $user->avatar }}');">
                        {{-- <div class="avatar av-m" style="background-image: url('{{ str_starts_with($user->avatar, "http") ? $user->avatar : asset("storage/users-avatar/" . $user->avatar) }}');"> --}}
