...
<div class="message-card @if ($isSender) mc-sender @endif" data-id="{{ $id }}">
    ...
    <div class="message-card-content">
        ...
        @if (@$attachment->type == "image" && (str_ends_with($attachment->file, ".jpg") || str_ends_with($attachment->file, ".jpeg") || str_ends_with($attachment->file, ".png") || str_ends_with($attachment->file, ".gif")))
        ...
        @if (@$attachment->type == "image" && (str_ends_with($attachment->file, ".mp4") || str_ends_with($attachment->file, ".mov")))
            <div class="video-wrapper" style="text-align: {{ $isSender ? "end" : "start" }};">
                <video controls style="max-width: 100%; border-radius: 8px;">
                    ...
                    <source src="{{ Chatify::getAttachmentUrl($attachment->file) }}" type="video/quicktime">
