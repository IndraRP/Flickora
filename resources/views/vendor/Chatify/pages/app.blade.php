        ...
        <div class="m-header m-header-messaging">
            <nav class="chatify-d-flex chatify-justify-content-between chatify-align-items-center">
                ...
                <div class="chatify-d-flex chatify-justify-content-between chatify-align-items-center">
                    ...
                    <a href="/chatify" class="user-name">{{ config("chatify.name") }}</a>
                </div>

                {{-- header buttons --}}
                <nav class="m-header-right">
                    <a href="/chatify" class="add-to-favorite"><i class="fas fa-star"></i></a>
                    <a href="/chatify"><i class="fas fa-home"></i></a>
                    <a href="/chatify" class="show-infoSide"><i class="fas fa-info-circle"></i></a>
                </nav>
            </nav>
            {{-- Internet connection --}}
